    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="absolute inset-0 bg-[var(--background)] transition-colors duration-500"
        >
          {/* Theme-Responsive Background Overlay */}
          <div className="absolute inset-0 bg-[var(--background)] pointer-events-none" />
          
          {/* Ambient Theme-Aware Lighting Glows */}
          <div
            className={`absolute -top-16 -right-16 w-80 h-80 rounded-full bg-[var(--primary)]/5 blur-3xl`}
          />
          <div className="absolute top-1/3 -left-20 w-72 h-72 rounded-full bg-[var(--primary)]/5 blur-3xl" />
          <div className="absolute -bottom-16 right-0 w-80 h-80 rounded-full bg-[var(--primary)]/5 blur-3xl" />



          {/* Artistic Ambient Pet Silhouette / Graphic watermark in background */}
          <motion.div 
            className="absolute right-2 top-24 opacity-[0.045] select-none pointer-events-none text-[var(--primary)]"
          ...
          <div className="absolute top-18 right-3 px-2 py-0.5 rounded-full bg-[var(--primary)]/10 border border-[var(--primary)]/20 text-[9px] font-bold text-[var(--primary)] backdrop-blur-xs flex items-center gap-1">
